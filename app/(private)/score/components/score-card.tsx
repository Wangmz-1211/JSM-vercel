...
import ScoreCardScoreDisplay from "@/app/(private)/score/components/score-card-score-display";
import ScoreCardProgress from "@/app/(private)/score/components/score-card-progress";
import {
	Sheet,
	SheetContent,
	SheetDescription,
...
import ScoreEditForm from "@/app/(private)/score/components/score-edit-form";
...
const ScoreCard = ({score}: { score: any }) => {
	...
	const progress = useMemo(() => {
		...
		return val;
	}, [record.vocabulary_score, record.grammar_score, record.reading_score, record.listening_score])
	return (
		<Sheet open={open} onOpenChange={setOpen}>
			...
			<SheetContent>
				<SheetHeader>
					<SheetTitle><FileEdit className="inline-block mr-2 mb-1"/>Edit the score record</SheetTitle>
					<SheetDescription>
